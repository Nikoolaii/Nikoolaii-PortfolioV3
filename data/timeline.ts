export const workTimeline = [
  ...
  {
    title: 'timeline.nordreprog.title',
    subtitle: 'NordReprog',
    type: 'timeline.apprenticeship',
...
export const schoolTimeline = [
  {
    title: 'timeline.bts_sio.title',
    subtitle: 'Gaston Berger - Lille',
    date: '09/2021 - 07/2023',
    content: [
      'timeline.bts_sio.content.1',
      'timeline.bts_sio.content.2',
      'timeline.bts_sio.content.3',
  ...
  {
    title: 'timeline.esgi_1.title',
    subtitle: 'ESGI - Lille',
    date: '09/2023 - 08/2024',
    content: [
      'timeline.esgi_1.content.1',
      'timeline.esgi_1.content.2',
  ...
  {
    title: 'timeline.esgi_2.title',
    subtitle: 'ESGI - Lille',
    date: '09/2024 - 08/2025',
    content: [
      'timeline.esgi_2.content.1',
